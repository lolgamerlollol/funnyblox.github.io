...
$connection = mysql_connect("localhost","socialpa_user","lolkpass123") or die("We are currently overloaded with users. Please try again in 1-5 minutes. Do not constantly refresh the page.");
mysql_select_db("socialpa_database") or die("We are currently overloaded with users. Please try again in 1-5 minutes. Do not constantly refresh the page.");
	...
	if ($myU->Ban == "1" && $_SERVER['PHP_SELF'] != "/Banned.php") {
		...
		header("Location: http://social-paradise.net/Banned.php");
